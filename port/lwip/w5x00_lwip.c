...
err_t netif_initialize(struct netif *netif)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    // 20240620 using <W5x00 chip mac>
    //SMEMCPY(netif->hwaddr, mac, sizeof(netif->hwaddr));
    uint8_t temp_mac[6] = {0,};
    getSHAR(temp_mac);
    SMEMCPY(netif->hwaddr, temp_mac, sizeof(netif->hwaddr));    
    ///////////////////////////////////////////////////////////////////////////////////////////////////
